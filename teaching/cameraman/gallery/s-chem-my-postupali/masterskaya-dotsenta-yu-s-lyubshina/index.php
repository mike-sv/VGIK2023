...
$APPLICATION->SetTitle("Мастерская доцента Ю.С. Любшина");
?>
...
<?php $files = scandir('../../../../../gallery/20230124/lubshin/');

foreach($files as $file) {

if (!in_array($file, array('.', '..', 'JPEG.zip'))) {
?>
<img alt="" data-description="" src="https://vgik.info/gallery/20230124/lubshin/<? echo $file; ?>" data-image="https://vgik.info/gallery/20230124/lubshin/<? echo $file; ?>" style="display:none">
<?php } ?>
<?php } ?>
</div>
