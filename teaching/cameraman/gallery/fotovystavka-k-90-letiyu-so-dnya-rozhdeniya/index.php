...
$APPLICATION->SetTitle("Фотовыставка к 90-летию со дня рождения");
?>
...
<?php $files = scandir('../../../../gallery/20230124/usov/');

foreach($files as $file) {

if (!in_array($file, array('.', '..', 'JPEG.zip'))) {
?>
<img alt="" data-description="" src="https://vgik.info/gallery/20230124/usov/<? echo $file; ?>" data-image="https://vgik.info/gallery/20230124/usov/<? echo $file; ?>" style="display:none">
<?php } ?>
<?php } ?>
</div>
